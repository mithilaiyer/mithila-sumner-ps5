...
#Create the function that scrapes dates 
def scrape_dates(user_date): 
    ...
    while True: 
        ...
        for div in div_tags: 
            date_text = div.find('span', class_='text-base-dark').get_text()
...
def main(): 
    user_date = get_dates() 
    scraped_dates = scrape_dates(user_date)
    print(scraped_dates)
